...
text = """
        ...
        _                       _                           
  __ _ | |_        __ _   __ _ | |  __ _ __  __ _   _       
 / _` || __|      / _` | / _` || | / _` |\ \/ /| | | |      
| (_| || |_      | (_| || (_| || || (_| | >  < | |_| |      
 \__, | \__|_____ \__, | \__,_||_| \__,_|/_/\_\ \__, |_____ 
...
class galaxy:
    ...
    def main(self):
        ...
        self.change_title("TikTok Automator using @gt.galaxy_ | Github: @izzetomarovcff")
        print(self.color + text)
        self.driver.get(self.url)
        print("\n" + self._print("Waiting for @gt.galaxy_ to load... 502 Error = Blocked country or VPN is on"))
        ...
        print(self._print(f"You can also get updates when @gt.galaxy_ updates the bots and more."))
    ...
    def send_bot(self, search_button, main_xpath, vid_info, div):
        ...
        if "(s)" in str(full):
            ...
            time.sleep(2)
        time.sleep(3)
        #input('Press ENTER to continue. This may cause errors, please ss gt.galaxy before incase.')
    ...
    def main_sleep(self, delay):
        while delay != 0:
            time.sleep(1)
            delay -= 1
            self.change_title(f"TikTok gt.galaxy Automator using gt.galaxy.com | Cooldown: {delay}s | Github: @gt.galaxy")
